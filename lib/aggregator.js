...
Aggregator.prototype.process = function (tree) {
  ...
  this._globalGroup.processOccurance(tree);

  //Group the object then process it. Only process the group if one exists
...
Aggregator.prototype.export = function () {
  var globalExport = this._globalGroup.export();
  return {
    occurances: globalExport.occurances,
    attributes: globalExport.attributes,
    groups: _.invoke(this._groups, "export")
  };
};
